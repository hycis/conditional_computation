...
#                                  'cifar10/pylearn2_gcn_whitened/train.pkl')
            ...
            X = np.load(os.environ['PYLEARN2_DATA_PATH'] + '/cifar10/train_X.npy', dtype=np.float32)
            y = np.load(os.environ['PYLEARN2_DATA_PATH'] + '/cifar10/train_y.npy', dtype=np.float32)
...
#             X = pkl.X
#             y = pkl.y
            X = np.load(os.environ['PYLEARN2_DATA_PATH'] + '/cifar10/test_X.npy', dtype=np.float32)
            y = np.load(os.environ['PYLEARN2_DATA_PATH'] + '/cifar10/test_y.npy', dtype=np.float32)
